...
public class JsonOAuth2ExceptionRenderer implements OAuth2ExceptionRenderer {

    private final Logger logger = LoggerFactory.getLogger(DefaultOAuth2ExceptionRenderer.class);
    ...
    private void writeWithMessageConverters(Object returnValue, HttpInputMessage inputMessage,
        ...
        List<MediaType> acceptedMediaTypes = Arrays.asList(MediaType.APPLICATION_JSON);
